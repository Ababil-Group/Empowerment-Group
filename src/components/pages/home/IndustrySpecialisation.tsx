...
import { Car, Building2, CircuitBoard, Users, Radio, Landmark, ChevronLeft, ChevronRight } from 'lucide-react'
import { 
  headingVariants, 
  paragraphVariants 
...
const industries = [
  {
    title: 'Automobile & Auto Component',
    icon: Car,
    description: 'Leading automotive recruitment solutions'
  },
  {
  ...
  },
  {
    title: 'Industrial',
    icon: Building2,
    description: 'Industrial workforce solutions'
  },
  {
    title: 'Technology',
    icon: CircuitBoard,
    description: 'Tech talent acquisition specialists'
  },
  {
    title: 'Consumer',
    icon: Users,
  ...
  },
  {
    ...
    icon: Radio,
    description: 'Media industry talent solutions'
  }
]
    ...
    <section className="py-12 sm:py-16 md:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16">
          ...
          >
            Expertise across diverse sectors, delivering specialized recruitment solutions tailored to your industry
          </motion.p>
        </div>
              ...
              {industries.map((industry, index) => {
                ...
                return (
                  <motion.div
                    ...
                    animate={{ 
                      x: position * (window.innerWidth < 640 ? 200 : 280) - (window.innerWidth < 640 ? 70 : 100),
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <div className={`w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 rounded-full flex items-center justify-center p-4 sm:p-6 relative shadow-lg transition-all duration-300 
                        ${position === 0 ? 'bg-blue-50' : 'bg-white'}`}
                      >
                        <industry.icon className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 transition-colors duration-300
                          ${position === 0 ? 'text-primary' : 'text-gray-400'}`} />
                        {position === 0 && <CircularProgress onComplete={handleProgressComplete} />}
                      </div>
