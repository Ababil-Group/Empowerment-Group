...
const services = [
  ...
  },
  {
    ...
    description: "Comprehensive hiring services",
    image: "/images/service2.jpg"
  },
  {
    title: "HR Consulting",
    description: "Expert HR advisory services",
    ...
    >
      <CardContent className="p-0 relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-5 md:p-6 text-white">
          ...
          <p className="text-xs sm:text-sm text-gray-200 mb-3 sm:mb-4">{description}</p>
          ...
          <div className="relative w-7 sm:w-8 md:w-10 h-7 sm:h-8 md:h-10">
            ...
            >
              <span className={`absolute text-[10px] sm:text-sm whitespace-nowrap
...
const OurServices = () => {
  ...
  return (
    <section id="allservices" className="relative py-12 sm:py-16 md:py-20 overflow-hidden">
      {/* Split Background */}
      ...
      <div className="container relative mx-auto px-4"> 
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            Comprehensive solutions to meet your organization&apos;s talent acquisition and management needs
          </motion.p>
        </div>
