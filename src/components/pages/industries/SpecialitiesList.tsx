...
const SpecialitiesList: React.FC<SpecialitiesListProps> = ({ specialities }) => {
  return (
    <motion.div
      initial="hidden"
      animate="visible"
    ...
    >
      <div className="bg-white p-4 sm:p-8 rounded-xl shadow-sm">
        <h2 className="text-xl sm:text-2xl font-bold mb-4 sm:mb-6 text-center">Our Specialities</h2>
