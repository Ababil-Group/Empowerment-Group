          ...
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              >
                ...
                >
                  Our Leadership Hiring services focus on identifying and attracting 
                  exceptional talent for key leadership positions across various 
                  organizational levels and functions. We understand that effective 
                  leadership is crucial for driving organizational success and growth.
                </motion.p>
                ...
                <motion.p 
                  ...
                  className="leading-relaxed"
                >
                  With our extensive network and proven assessment methodologies, 
                  we help organizations build strong leadership teams that align 
                  with their strategic objectives and cultural values. Our comprehensive 
                  approach ensures the right fit for both the organization and the candidate.
                </motion.p>
              </motion.div>
